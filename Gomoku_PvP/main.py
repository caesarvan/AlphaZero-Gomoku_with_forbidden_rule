...
screencaption = pygame.display.set_caption('五子棋人人对战')
...
while True:
    ...
    screen.fill((240,230,140)) # 将界面设置为淡黄色
    ...
    for x, y, c in chess_arr:
        chess_color = (30,30,30) if c == 1 else (220,220,220)
        pygame.draw.circle(screen, chess_color, [x*cell_size+space, y*cell_size+space], 16,16)

    if game_state != 1:
        myfont = pygame.font.Font(None,60)
        win_color = 0,0,128 #海军蓝
        win_text = "%s win"%('black' if game_state == 2 else 'white')
        winner = myfont.render(win_text, True, win_color)
        screen.blit(winner, (260,20))
